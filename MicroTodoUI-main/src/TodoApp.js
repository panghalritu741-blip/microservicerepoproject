...
const GET_TASKS_API_BASE_URL = "http://get-tasks.6weathers.com";
const DELETE_TASK_API_BASE_URL = "http://delete-task.6weathers.com";
const CREATE_TASK_API_BASE_URL = "http://add.6weathers.com";
